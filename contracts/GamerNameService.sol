...
contract GamerNameService is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Gamer Name Service", "GMRtag") {}
    ...
    // Custom Hook to update mapping of default GMRtag on all transfers
    ...
    // Custom function for selection of default GMRtag owned by msg.sender

    function setDefaultGMRtag(uint256 tokenId) public virtual {
